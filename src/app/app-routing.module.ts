...
const routes: Routes = [
  ...
  {path:'home',component:DisplaynewvehicleComponent},
  {path:'addvehicleentry',component:AddvehileentryComponent},
  {path:'addtoll',component:AddtollComponent},
  {path:'viewtolls',component:ViewtollComponent },
];
